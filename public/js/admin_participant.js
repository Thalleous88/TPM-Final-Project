...
function renderGroups(groupData) {
    ...
    // event listener edit team
    document.querySelectorAll(".edit").forEach((button) => {
        button.addEventListener("click", (e) => {
            const groupId = Number(e.target.getAttribute("data-id")); // Pastikan ID berupa number
            console.log("Redirecting to edit ID:", groupId);
            window.location.href = `edit_team.html?id=${groupId}`;
        });
    });
