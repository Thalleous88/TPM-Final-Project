...
<html lang="en">
    <head>
        ...
        />
        <link rel="stylesheet" href="{{ asset('css/register_new_member2.css') }}">
        <script src="{{ asset('js/register_new_member2.js') }}"></script>
    </head>
    <body>
        <div class="header">
            <img
            ...
            <div class="content">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        <p class="add-member">
                            *Add another member? 
                            <a href="register_new_member1.html" class="highlight new-member-link">New member</a>
                        </p>
        ...
        <script src="register_new_member2.js"></script>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        <link
            ...
            href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        />
        <link rel="stylesheet" href="register_new_member2.css" />
    </head>
    <body>
        <div class="header">
            <img
