...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="register_lomba1.css" />
  </head>
  <body>
    <div class="header">
      <img
      ...
      <div class="content">
        ...
        <div class="form-container">
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="status"
                ><i class="fas fa-graduation-cap"></i> Status</label
              >
              <div class="status">
                <input
                  type="radio"
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="requirements" id="password-requirements">
                ...
                *Must include an uppercase letter<br />
    ...
    <script src="register_lomba1.js"></script>
  </body>
</html>
