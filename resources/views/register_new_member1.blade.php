    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <form id="registration-form" action="{{ route('storeMember2Page1') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="back-button">
                                    <button type="button" onclick="window.location.href='/register/member12';">
